Given what you've just done, please save your investigation as a markdown file at `$ARGUMENTS`. If no path was given to you, save to cwd /.docs/[relevant-name].md
